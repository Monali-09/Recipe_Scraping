...
public class SouthIndianTest {
	...
	public void recipeScrappingSouthIndian() throws Exception 
	{
		...
		recipePageObj.textbox("South Indian");
		...
		xlUtils.setCellData("Sheet7", 0, 0, "Title");
		xlUtils.setCellData("Sheet7", 0, 1, "Category");
		xlUtils.setCellData("Sheet7", 0, 2, "Ingredients");
		xlUtils.setCellData("Sheet7", 0, 3, "Method/Recipe Steps");
		xlUtils.setCellData("Sheet7", 0, 4, "Nutrient Values ");
		xlUtils.setCellData("Sheet7", 0, 5, "Recipe image link");
		xlUtils.setCellData("Sheet7", 0, 6, "Link to the recipe");
		...
		for(int i=1;i<links.size();i++)
		{
			...
			xlUtils.setCellData("Sheet7", i, 0, title);
			xlUtils.setCellData("Sheet7", i, 1, category);
			xlUtils.setCellData("Sheet7", i, 2, ingredients);
			xlUtils.setCellData("Sheet7", i, 3, recipeSteps);
			xlUtils.setCellData("Sheet7", i, 4, nutriotionVal);
			xlUtils.setCellData("Sheet7", i, 5, imageLink);
			xlUtils.setCellData("Sheet7", i, 6, recipeLink);
