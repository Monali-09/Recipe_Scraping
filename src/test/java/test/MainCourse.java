...
public class MainCourse 
{
	...
	@Test
	public void recipeScrappingMaincourse() throws Exception 
	{
		...
		recipePageObj.textbox("Rice");
		recipePageObj.search();
		recipePageObj.linkclick();
	
		ExcelUtils xlUtils =  new ExcelUtils(".\\RecipeData\\RecipeData.xlsx") ;

		xlUtils.setCellData("Sheet8", 0, 0, "Title");
		xlUtils.setCellData("Sheet8", 0, 1, "Category");
		xlUtils.setCellData("Sheet8", 0, 2, "Ingredients");
		xlUtils.setCellData("Sheet8", 0, 3, "Method/Recipe Steps");
		xlUtils.setCellData("Sheet8", 0, 4, "Nutrient Values ");
		xlUtils.setCellData("Sheet8", 0, 5, "Recipe image link");
		xlUtils.setCellData("Sheet8", 0, 6, "Link to the recipe");
		...
		for(int i=1;i<links.size();i++)//links.size()
		{
			...
			xlUtils.setCellData("Sheet8", i, 0, title);
			xlUtils.setCellData("Sheet8", i, 1, category);
			xlUtils.setCellData("Sheet8", i, 2, ingredients);
			xlUtils.setCellData("Sheet8", i, 3, recipeSteps);
			xlUtils.setCellData("Sheet8", i, 4, nutriotionVal);
